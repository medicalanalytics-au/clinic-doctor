...
// custom functions
import { downloadMessages, isToday, showError, useResponsiveMedia } from "../../../utils/helpers"

// custom components
import SideMenu from "./SideMenu"

import { common_sendMessage, common_updateReadStatus } from "../../../utils/network"
import { closeMessage, openMessage, setMessageMode, setMessageRecipient, setMessages, setMessageView } from "../../../utils/context"

// constants
import { MODE, VIEW } from "../../../utils/context"
import { MAINCOLOR_LIGHT, MEDIA, ORIENTATION } from "../../../utils/constants"
...
export const changeReadStatus = (dispatch, id, messages, status) => {
	common_updateReadStatus(dispatch, id, status)
		.then(() => {
